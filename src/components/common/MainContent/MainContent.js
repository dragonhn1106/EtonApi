                ...
                <div className="row">
                    ...
                    <div className="main-content">
                        ...
                        <div className="main-content__body">
                            <p>ETON External API is a RESTful API that caters for creation of SaleOrder or
                            PurchaseOrder resource and also actions like getting the other data such as
                            Address, Product,...
                            </p>
